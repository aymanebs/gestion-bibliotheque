<?php require __DIR__ ."/../../../app/controllers/admin/users/edit.php"; ?>
...
<!-- form start -->
                <form class="mx-1 mx-md-4"  method="post" action="/app/controllers/admin/users/edit.php" style="font-size:medium" >
